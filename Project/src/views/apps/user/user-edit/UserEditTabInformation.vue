  ...
  <div id="user-edit-tab-info">
    ...
    <div class="vx-col" id="avatar-col">
            <div class="img-container mb-4">
              <img :src="data.avatar" class="rounded w-full" />
            </div>
            <input type="file" class="hidden" ref="update_avatar_input" @change="update_avatar" accept="image/*">
            <vs-button type="border" class="mr-4" @click="$refs.update_avatar_input.click()">Change Avatar
            </vs-button>
    </div>
        ...
        <vs-input class="w-full mt-4" v-model="data_local.username" v-validate="'required|alpha_num'" name="username" />
